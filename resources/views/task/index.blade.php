                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach ($tasks as $task)
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('task.show', $task->id) }}" style="text-decoration: none">{{ $task->name }}</a></td>
                            ...
                            @auth
                                <td style="min-width: 100px;">
                                    ...
                                    @if($task->author->id === Auth::user()->id)
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="example{{ $task->id }}Modal" tabindex="-1" aria-labelledby="example{{ $task->id }}ModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="example{{ $task->id }}ModalLabel">Вы уверены ?</h1>
